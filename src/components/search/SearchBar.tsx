          ...
          <div className="py-2">
            ...
            {suggestions.map((article) => (
              <button
                ...
                className="w-full px-3 py-2 text-left hover:bg-gray-50 transition-colors border-none bg-transparent"
              >
            ...
            {query && (
              <button
                ...
                className="w-full px-3 py-3 text-left hover:bg-blue-50 transition-colors border-t border-gray-100 text-blue-600 font-medium"
              >
