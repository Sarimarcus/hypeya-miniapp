...
const mockAuthors = [
  {
    ...
    avatarUrl: 'https://images.unsplash.com/photo-1494790108755-2616b612b3f7?w=96&h=96&fit=crop&crop=face'
  },
  {
    id: 2,
...
const mockTags: Tag[] = [
  ...
  { id: 6, name: 'Performance', slug: 'performance', description: '', count: 10 },
...
<p>Modern AI tools are revolutionizing how we write, test, and deploy code. Here are some essential tools...</p>`,
    excerpt: 'Artificial Intelligence is rapidly transforming the software development landscape. Discover the key trends and technologies every developer should know in 2025.',
...
<p>We'll explore everything from component optimization to bundle splitting, ensuring your React applications deliver exceptional user experiences.</p>`,
    excerpt: 'Learn advanced React performance optimization techniques for 2025. From component optimization to bundle splitting - make your React apps lightning fast.',
...
<p>From cross-platform frameworks to AI-powered features, this article covers the essential trends every mobile developer should be following.</p>`,
    excerpt: 'Discover the mobile app development trends that will dominate 2025. Stay ahead with insights on cross-platform frameworks and AI-powered features.',
...
<p>Let's dive deep into the most important features and how they can improve your development workflow and application performance.</p>`,
    excerpt: 'Explore the revolutionary features of Next.js 15 that are changing how developers build React applications. Performance improvements and DX enhancements.',
...
<p>From smart contracts to DeFi applications, we'll explore the tools, frameworks, and best practices for building on blockchain platforms.</p>`,
    excerpt: 'Master blockchain development in 2025 with this complete guide. Learn about smart contracts, DeFi, and the latest development tools.',
...
<p>We'll cover everything from frontend frameworks to deployment strategies, helping you make informed decisions for your startup's technical foundation.</p>`,
    excerpt: 'Choose the perfect tech stack for your startup in 2025. Comprehensive analysis of frameworks, tools, and deployment strategies for success.',
...
export class MockWordPressApiService {
  ...
  async searchArticles(query: string, page = 1, perPage = 12): Promise<ApiResponse<Article[]>> {
    ...
    const filteredArticles = mockArticles.filter(article =>
      ...
      article.categories.some(cat => cat.name.toLowerCase().includes(searchLower))
    );
