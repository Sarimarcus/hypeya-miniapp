...
export async function GET() {
  ...
  return Response.json({
    ...
    frame: withValidProperties({
      ...
      primaryCategory: process.env.NEXT_PUBLIC_APP_PRIMARY_CATEGORY || "news-media",
      tags: [],
      heroImageUrl: process.env.NEXT_PUBLIC_APP_HERO_IMAGE || `${URL}/images/hypeya-logo.png`,
      tagline: process.env.NEXT_PUBLIC_APP_TAGLINE || "Tendencias virales y memes",
      ogTitle: process.env.NEXT_PUBLIC_APP_OG_TITLE || "HYPEYA - Tendencias virales",
      ogDescription: process.env.NEXT_PUBLIC_APP_OG_DESCRIPTION || "Descubre lo más viral en HYPEYA: memes, tendencias y cultura web fresca.",
      ogImageUrl: process.env.NEXT_PUBLIC_APP_OG_IMAGE || `${URL}/images/hypeya-logo.png`,
