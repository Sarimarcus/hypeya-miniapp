...
export const API_PARAMS = {
  ...
  FIELDS: {
    ...
    POSTS:
      "id,date,slug,link,title,content,excerpt,author,featured_media,categories,tags,_embedded",
    POST_PREVIEW:
      "id,date,slug,link,title,excerpt,author,featured_media,categories,tags,_embedded",
...
export const API_REQUESTS = {
  ...
  LATEST_ARTICLES: (
    page: number = 1,
    perPage: number = API_PARAMS.PER_PAGE.ARTICLES
  ) => ({
